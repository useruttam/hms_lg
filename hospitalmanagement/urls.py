...
urlpatterns = [
    ...
    path('doctor-update-appointment/<int:pk>',
         views.doctor_update_appointment_view, name='doctor-update-appointment'),
    path('prescription-doc-update/<int:pk>',
         views.update_appointment_view, name='prescription-doc-update'),
